...
/**
 * Options accepted by {@link buildXmlPlist}.
 */
export interface BuildXmlPlistOptions {
  /**
 ...
 * value mapping and {@link BuildXmlPlistOptions} for layout control.
 *
 ...
 * @param options See {@link BuildXmlPlistOptions}.
 ...
 */
export function buildXmlPlist(value: PlistValue, options: BuildXmlPlistOptions = {}): string {
